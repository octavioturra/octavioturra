(defproject octavioturra "0.1.0-SNAPSHOT"
  ...
  :ring {:handler octavioturra.handler/app
         :uberwar-name "octavioturra.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "octavioturra.jar"

  :main octavioturra.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             ...
             :compiler {:main "octavioturra.cards"
